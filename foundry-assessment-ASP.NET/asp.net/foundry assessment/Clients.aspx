...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr />
    <asp:GridView ID="gvClients" runat="server" PageSize="3" AllowPaging="false" CssClass="mydatagrid" RowStyle-CssClass="rows" AutoGenerateColumns="false" OnRowEditing="OnRowEditing" OnRowUpdating="OnRowUpdating" OnRowCancelingEdit="OnRowCancellingEdit"
